 ...
 * A simple server that requires payment to access protected resources
 */
...
/**
 * Facilitator endpoints (simulating external facilitator service)
 */
...
app.get('/facilitator/supported', (req: Request, res: Response) => {
